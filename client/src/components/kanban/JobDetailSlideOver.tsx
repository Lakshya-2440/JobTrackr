...
export const JobDetailSlideOver = () => {
  ...
  return (
    <>
      ...
      <aside className="fixed inset-y-0 right-0 z-50 flex w-full max-w-2xl flex-col border-l border-slate-200 bg-white shadow-soft transition-all dark:border-slate-800 dark:bg-slate-950">
