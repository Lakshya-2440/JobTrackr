...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-slate-800 bg-slate-950 p-4 shadow-soft transition-transform lg:translate-x-0 lg:shadow-none',
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={closeSidebar}
            className="rounded-full p-2 text-slate-400 transition hover:bg-slate-900 hover:text-slate-200 lg:hidden"
